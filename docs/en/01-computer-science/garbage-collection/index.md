...
description: "TODO — one-sentence description of Garbage Collection"
...
TODO: Explain Garbage Collection in simple language.
...
```mermaid
flowchart LR
  concept[GarbageCollection] --> nextStep[NextStep]
```
