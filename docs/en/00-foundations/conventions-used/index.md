...
description: "TODO — one-sentence description of Conventions Used"
...
TODO: Explain Conventions Used in simple language.
...
```mermaid
flowchart LR
  concept[ConventionsUsed] --> nextStep[NextStep]
```
