...
description: "TODO — one-sentence description of Event Loop (Runtime View)"
...
TODO: Explain Event Loop (Runtime View) in simple language.
...
```mermaid
flowchart LR
  concept[EventLoopRuntimeView] --> nextStep[NextStep]
```
