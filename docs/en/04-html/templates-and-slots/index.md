...
description: "TODO — one-sentence description of Templates and Slots"
...
TODO: Explain Templates and Slots in simple language.
...
```mermaid
flowchart LR
  concept[TemplatesandSlots] --> nextStep[NextStep]
```
