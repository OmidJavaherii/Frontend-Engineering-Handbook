...
description: "TODO — one-sentence description of Space Complexity"
...
TODO: Explain Space Complexity in simple language.
...
```mermaid
flowchart LR
  concept[SpaceComplexity] --> nextStep[NextStep]
```
