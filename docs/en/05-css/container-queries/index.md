...
description: "TODO — one-sentence description of Container Queries"
...
TODO: Explain Container Queries in simple language.
...
```mermaid
flowchart LR
  concept[ContainerQueries] --> nextStep[NextStep]
```
