...
description: "TODO — one-sentence description of Prerequisites Checklist"
...
TODO: Explain Prerequisites Checklist in simple language.
...
```mermaid
flowchart LR
  concept[PrerequisitesChecklist] --> nextStep[NextStep]
```
