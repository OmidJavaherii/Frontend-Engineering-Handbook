...
description: "TODO — one-sentence description of Document Structure"
...
TODO: Explain Document Structure in simple language.
...
```mermaid
flowchart LR
  concept[DocumentStructure] --> nextStep[NextStep]
```
